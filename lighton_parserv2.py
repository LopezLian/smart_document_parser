...
class LightOnOCRParser:
    ...
    def __init__(self,
                 ...
                 output_dir="./output",
                 dpi=200,
                 max_new_tokens=4096):  # Docs recommend up to 4096 for full pages
        ...
        with torch.no_grad():
            output_ids = self.model.generate(
                **inputs,
                ...
                use_cache=True,
                do_sample=False,            # <--- NEW: Prevents the model from wildly guessing noise at the end of a page
                repetition_penalty=1.15     # <--- NEW: Mathematically punishes the model for repeating tokens
            )
